 ...
 *    - 1: Found `key`
 */
// int btree_node_find_key(BTreeNode* root, int key, BTreeNode** node_ptr, int*
// key_idx_ptr, BTreeNode** last_over_min_cap_anc_ptr, int*
// num_min_cap_ancestors_ptr, int inc_subtree_sizes)
